    ...
    <div className="flex items-center justify-center min-h-screen p-6 bg-canvas">
      <div className="w-full max-w-[380px] bg-surface border border-border-subtle rounded-[6px] p-6">
        <div className="mb-6">
          ...
          <p className="text-ink-secondary text-xs">Initialize a new secure operator node</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4 flex flex-col gap-1.5">
            <label className="font-mono text-[11px] uppercase tracking-wider text-ink-secondary" htmlFor="name">
              Operator Name
            </label>
        ...
        <div className="mt-5 text-center text-xs text-ink-secondary">
          ...
          <Link href="/login" className="text-accent-system font-mono underline underline-offset-4 hover:text-ink-primary">
            Connect Session
          </Link>
        </div>
      </div>
